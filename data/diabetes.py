...
class Diabetes(object):
    def __init__(self, P, tabular_size, seed, source, shot, tasks_per_batch, test_num_way, query, eps):
        ...
        self.unlabeled_x = np.load('./data/diabetes/train_x.npy')
        self.test_x = np.load('./data/diabetes/xtest.npy')
        self.test_y = np.load('./data/diabetes/ytest.npy')
        self.val_x = np.load('./data/diabetes/val_x.npy')
        self.val_y = np.load(
            './data/diabetes/yval.npy')
