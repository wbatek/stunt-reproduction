...
def retrieve(seed):
    ...
    project_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'optdigits'))
    os.makedirs(project_dir, exist_ok=True)

    data, meta = arff.loadarff(os.path.join(project_dir, "dataset_28_optdigits.arff"))
